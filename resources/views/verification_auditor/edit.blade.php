...
<div class="row">
    <div class="col-md-12">
        <ul class = "breadcrumb">
            ...
            <li>
                <a href = "{{ url('/auditor_verification') }}"> NCR Auditor Verification </a>
            </li>
        </ul>
...
{{-- 
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Edit Verifikasi NCR oleh MMLH</h3>
        </div>
        <div class="box-body">

            {!! Form::model($auditor_verification, ['url' => route('auditor_verification.editAuditorVerification', $auditor_verification->id), 'method' => 'put' , 'files' => 'true' , 'class' => 'form-horizontal'])
