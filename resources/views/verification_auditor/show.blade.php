...
<div class="row">
    <div class="col-md-12">
        <ul class = "breadcrumb">
            ...
            <li class = "active" > NCR Auditor Verification Print </a> </li>
        </ul>
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">NCR Auditor Verification Print</h3>
        </div>
        <div class="box-body">
            <div class="col-md-10">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3"><p>Nama Produk/Proses</p></div>
                ...
                <div class="row">
                    <div class="col-md-3"><p>Verifikasi MMLH</p></div>
                    @if(!is_null($auditor_verification))
                        <div class="col-md-9"><p>: {!! ($auditor_verification->verification_description) !!}</p></div>
                    @elseif(is_null($auditor_verification))
                        <div class="col-md-9"><p>: </p></div>
                    @endif
                </div>

                <div class="row">
                    <div class="col-md-3"><p>Hasil Verifikasi</p></div>
                    @if(!is_null($auditor_verification))
                        <div class="col-md-9"><p>: {{ ($auditor_verification->ver_result->description) }}</p></div>
                    @elseif(is_null($auditor_verification))
                        <div class="col-md-9"><p>: </p></div>
                    @endif
                </div>
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-5 col-md-offset-5">
                        <a class="btn btn-primary" href="{{ url('auditor_verification/'. $resp_data->id .'/print_pdf') }}" target="_blank"><i class="glyphicon glyphicon-print" aria-hidden="true"> Print</i></a>
                    </div>
                </div>
            </div>
