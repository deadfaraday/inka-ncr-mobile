...
<div class= "form-group{{ $errors->has('ver_result_id') ? 'has-error': '' }} ">
    {!! Form::label('ver_result_id', 'Hasil Verifikasi', ['class'=>'col-md-4 control-label']) !!}
    <div class = "col-md-5">
        {!! Form::select ('ver_result_id', [ '' => '' ]+App\VerificationResult::pluck('description','id')->all(),null,
            [
                'class' => 'js-selectize',
                'placeholder' => 'Pilih Hasil Verifikasi'
            ])         
        !!}  
        {!! $errors->first('ver_result_id', '<p class= "help-block">:message</p>') !!}
    </div>
</div>

<div class= "form-group{{ $errors->has('verification_description') ? 'has-error': '' }} ">
    {!! Form::label('verification_description', 'Tindakan Perbaikan', ['class'=>'col-md-4 control-label']) !!}
    <div class = "col-md-5">
