...
<div class="row">
    <div class="col-md-12">
        <ul class = "breadcrumb">
            ...
            <li> <a href = "{{ url('/inspector_verification') }}"> Verifikasi NCR </a>
            <li class= "active"> Verifikasi NCR oleh Inspektor </li>
        </ul>
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">NCR Inspector Validation Print</h3>
        </div>
        <div class="box-body">
            <div class="col-md-10">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9"><p>: {!! ($inspector_verification->verification_description) !!}</p></div>
                </div>

                <div class="row">
                    <div class="col-md-3"><p>Hasil Verifikasi</p></div>
                    <div class="col-md-9"><p>: {{ ($inspector_verification->ver_result->description) }}</p></div>
                </div>
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-5 col-md-offset-5">
                        <a class="btn btn-primary" href="{{ url('inspector_verification/'. $resp_data->id .'/print_pdf') }}" target="_blank"><i class="glyphicon glyphicon-print" aria-hidden="true"> Print</i></a>
                    </div>
                </div>
            </div>
