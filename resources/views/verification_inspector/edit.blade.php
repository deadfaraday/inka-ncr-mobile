...
@section('content-title', 'Verifikasi NCR oleh Inspektor ')
...
{{--          
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Verifikasi NCR oleh Inspektor</h3>
        </div>
        <div class="box-body">
             {!! Form::model($verification,
                ['url' => route('inspector_verification.update_verification',$verification->id) ,
                'method' => 'put' , 'files' => 'true' , 'class' => 'form-horizontal']) !!}
                @include('verification_inspector._form')
            ...
            <div class = "col-md-12">
                ...
                <div class= "panel panel-default">
                    <div class= "panel-heading">
                        <h2 class = "panel-title"> Tindak Lanjut NCR</h2>
                    </div>

                    <div class = "panel-body">

                         {!! Form::open(['url' => url('ncr_resp/'.$ncr_id),
                            'method' => 'put' , 'files' => 'true' , 'class' => 'form-horizontal']) !!}
                            @include('ncr_response._form')
