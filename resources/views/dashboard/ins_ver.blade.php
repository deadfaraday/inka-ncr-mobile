...
<div class="row">
    <div class="col-md-12">
        <ul class = "breadcrumb">
            ...
            <li class = "active" > Dashboard NCR - Verifikasi Inspektor </a> </li>
        </ul>
            ...
            <div class="col-lg-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Data NCR yang telah diverifikasi oleh inspektor</a></li>
                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div class='row'>
                                ...
                                <section class="col-lg-3 connectedSortable">
                                    ...
                                    <div class="box box-primary">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Hasil Verifikasi Inspektor</h3>
                                            <div class="box-tools pull-right">
                                                <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12">
                                                    ...
                                                    <div class="small-box bg-teal">
                                                        <div class="inner">
                                                            <h3 id= 'ncr_total'>{!! $ver_data->efektif->amount!!}</h3>

                                                            <p>{!! $ver_data->efektif->label!!}</p>
                                                        </div>
                                                        <div class="icon">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12">
                                                    ...
                                                    <div class="small-box bg-aqua">
                                                        <div class="inner">
                                                            <h3 id= 'ncr_total'>{!! $ver_data->not_efektif->amount!!}</h3>

                                                            <p>{!! $ver_data->not_efektif->label!!}</p>
                                                        </div>
                                                        <div class="icon">
